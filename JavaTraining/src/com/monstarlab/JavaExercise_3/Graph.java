...
public class Graph {
	...
	public void getShortestPath(Vertex originVertex, Vertex destinationVertex) {
		...
		// calculateMinimumDistance(adjacentVertex, edgeDistance,
		// currentVertex);
	...
	public void findValidPaths(Vertex originVertex, Vertex destinationVertex) {
		...
		List<Edge> x = originVertex.getNeighborEdges();

		for (Edge edge : x) {
			System.out.println("this is a neighbor edge of the current vertex" + edge.toString());
		}
		...
		// while (!done) {
		//
		// if (edge.getSecondVertex().getVertexNumber().intValue() ==
		// destinationVertex.getVertexNumber()
		// .intValue()) {
		// System.out.println("DONE WITH 1 PATH");
		// // path.add
		// }
		//
		// if (edge.getSecondVertex() == null) {
		// break;
		// }
		//
		// }
		...
		// Integer destinationVertexNumber =
		// destinationVertex.getVertexNumber();
		//
		// Integer firstVertexNumber =
		// edge.getFirstVertex().getVertexNumber();
		// Integer secondVertexNumber =
		// edge.getSecondVertex().getVertexNumber();
		//
		// if (originVertexNumber.equals(firstVertexNumber) &&
		// destinationVertexNumber.equals(secondVertexNumber)) {
