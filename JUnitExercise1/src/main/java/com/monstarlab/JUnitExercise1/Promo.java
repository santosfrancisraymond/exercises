...
/**
 * Santos, Francis & Cruz, Jason Anthony
 */
public class Promo {
	...
	public Promo(String promoCode, String promoName, BigDecimal productPrice, BigDecimal promoPercent,
			Integer promoMinimum, String promoType, BigDecimal promoDiscountAmount, String promoTarget) {
		super();
	...
	public ArrayList<Product> getFreebies(String freebiesString) {

		String[] freebiesArray = freebiesString.split(SEPARATOR);

		for (String freebie : freebiesArray) {
			// getFreebies().add(new Product(freebie));
		}
